# Research V2 Complete Implementation Guide
...
## Additional CSS for Perplexity Theme Integration

Add these styles to your existing CSS files or create a new one:

```css
/* Additional utility classes for Research V2 */
.bg-backdrop {
...
.focus\:ring-super:focus {
  --tw-ring-color: oklch(var(--super-color));
}

/* Custom checkbox styling */
input[type="checkbox"]:checked {
  background-color: oklch(var(--super-color));
  border-color: oklch(var(--super-color));
}

/* Enhanced button hover states */
.hover\:bg-super\/90:hover {
  background-color: oklch(var(--super-color) / 0.9);
}

.disabled\:bg-super\/50:disabled {
...
2. **Create the Vue component**:
   - Copy the complete component code above into `frontend/pages/research/v2/[searchId].vue`

3. **Test the route**:
   - Navigate to `/research/v2/your-search-id` to see the new page

4. **Verify functionality**:
   - Loading states should work
   - Sidebar should slide in/out smoothly
   - Form submission should update the research status
   - Progress bar should animate
   - Insights should appear with staggered animation

## Key Features Implemented

✅ **Modern Card-Based Layout**: Clean, consistent card design
✅ **Animated Sidebar**: Smooth slide-in/out with backdrop
✅ **Progress Tracking**: Animated progress bar and status updates
✅ **Staggered Animations**: Insights appear with delays
✅ **Form Integration**: Complete configuration form
✅ **Loading States**: Skeleton loaders and spinners
✅ **Success/Error Messages**: Animated feedback cards
✅ **Responsive Design**: Mobile-first approach
✅ **Theme Integration**: Uses existing Perplexity theme
✅ **Icon Integration**: Lucide icons throughout
✅ **Accessibility**: Proper labels and focus states

## Testing Checklist

- [ ] Page loads at `/research/v2/[searchId]`
- [ ] Loading skeletons appear initially
- [ ] Content fades in after loading
- [ ] Configure button opens sidebar
- [ ] Sidebar slides in smoothly with backdrop
- [ ] Form fields work correctly
- [ ] Form submission shows loading state
- [ ] Success message appears after submission
- [ ] Research status updates after form submission
...
This implementation provides a complete, production-ready Research V2 page that matches the design shown in the screenshots while integrating seamlessly with the existing Nuxt 3 application.