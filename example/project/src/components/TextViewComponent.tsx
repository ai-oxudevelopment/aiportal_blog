<template>
  <div class="mb-4">
    <div :class="`relative flex flex-col gap-1 rounded-md border-[0.5px] p-4 text-white [overflow-wrap:anywhere] ${getVariantStyles()}`">
      <div v-if="title" class="mb-2 flex items-center justify-between">
        <h3 class="text-sm font-medium text-neutral-400">{{ title }}</h3>
