  ...
  >
    ...
    <div class="p-4 flex-grow flex flex-col overflow-hidden">
      <!-- Description Text - Monospace like cursor.directory -->
        <div class="bg-zinc-800/50 border border-zinc-700/50 rounded-md p-1 mb-3 flex-grow">
          <code class="block text-gray-300 text-[9px] font-mono">
  ...
  <div v-if="isPreviewOpen" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div class="bg-zinc-900 border border-white/20 rounded-xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
      ...
      <div class="p-4 overflow-y-auto max-h-[60vh]">
        <pre class="text-gray-300 text-[9px] font-mono whitespace-pre-wrap leading-snug">{{ contentText }}</pre>
      </div>
  ...
  <div v-if="isAIDialogOpen" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div class="bg-zinc-900 border border-white/20 rounded-xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
      ...
      <div class="p-4 space-y-4 max-h-[50vh] overflow-y-auto">
        <!-- Prompt Display -->
        <div class="bg-zinc-800/50 rounded-md p-1 border border-zinc-700/50">
        ...
        <!-- AI Response -->
        <div v-if="aiResponse" class="bg-zinc-800/50 rounded-md p-1 border border-zinc-700/50">
          <h4 class="text-white text-sm font-medium mb-2">AI Response:</h4>
          <pre class="text-gray-300 text-[9px] font-mono whitespace-pre-wrap leading-snug">{{ aiResponse }}</pre>
        </div>
