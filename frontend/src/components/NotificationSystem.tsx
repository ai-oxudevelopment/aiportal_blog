...
// Comprehensive notification system with toast notifications
...
const Notification: React.FC<NotificationProps> = ({
  ...
  return (
    <div
      className={`
        relative rounded-md border p-4 shadow-sm transition-all duration-300 ease-in-out
        ${getBackgroundColor()}
...
// Toast notification component for quick usage
...
export const Toast: React.FC<ToastProps> = ({ type, message, duration = 5000 }) => {
