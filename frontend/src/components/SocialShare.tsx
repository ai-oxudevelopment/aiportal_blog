...
import { generateSocialShareUrls, copyToClipboard } from '@/lib/utils';
...
export default function SocialShare({
  ...
  const getButtonClasses = (platform: string) => {
    ...
    switch (variant) {
      case 'compact':
        return `${baseClasses} w-8 h-8 text-gray-500 hover:text-gray-700 hover:bg-gray-100`;
      case 'minimal':
        return `${baseClasses} w-6 h-6 text-gray-400 hover:text-gray-600`;
      default:
        return `${baseClasses} w-10 h-10 text-gray-500 hover:text-gray-700 hover:bg-gray-100`;
    }
  };
